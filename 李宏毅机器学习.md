...
- 判断方法：Hessian矩阵是二次微分矩阵
  ...
  <img src="../../AppData/Roaming/Typora/typora-user-images/image-20210312155725425.png" alt="image-20210312155725425" style="zoom:80%;" />
...
- 原则：梯度变化平缓，学习率设置大一点；反之，小一点
  ...
  <img src="../../AppData/Roaming/Typora/typora-user-images/image-20210316100705186.png" alt="image-20210316100705186" style="zoom:80%;" />
...
- 前面看到的输入都一样长，那么如果输入不一样长的序列会怎么办呢
  - 举例：输入序列this is a cat
    - 独热向量：一个词占一个维度，但没有突出单词间的关系
    - word embedding：每个词一个向量，同类词距离更近
  - 举例：音频、图结构（社交网络）、分子结构
- 输出情况：
  - 一个向量对应一个label【sequence labeling】：如POS tagging（标词性）、声音识别（HW2）
  - 所有向量对应一个label：Sentiment analysis（情感分析）、语音辨认
...
- 具体做法：
  ...
  <img src="https://yumytest.oss-cn-chengdu.aliyuncs.com/img/image-20210318151949157.png" alt="image-20210318151949157" style="zoom:67%;" />![image-20210318152052851](https://yumytest.oss-cn-chengdu.aliyuncs.com/img/image-20210318152052851.png)

  <img src="https://yumytest.oss-cn-chengdu.aliyuncs.com/img/image-20210318152147227.png" alt="image-20210318152147227" style="zoom:67%;" />![image-20210318152339780](https://yumytest.oss-cn-chengdu.aliyuncs.com/img/image-20210318152339780.png)

  ​	<img src="https://yumytest.oss-cn-chengdu.aliyuncs.com/img/image-20210318152403951.png" alt="image-20210318152403951" style="zoom:67%;" />
